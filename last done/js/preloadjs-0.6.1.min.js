...
function() {
    ...
    a.setResponseType = function(a) {
        "blob" === a && (a = window.URL ? "blob" : "arraybuffer",
        this._responseType = a),
        ...
        if (!this.loaded) {
            ...
            "arraybuffer" === this._responseType)
                try {
                    ...
                    "TypeError" === b.name && window.BlobBuilder) {
                        var c = new BlobBuilder;
                        c.append(this._response),
                        this._response = c.getBlob()
                    }
                }
            this._clean(),
...
function() {
    ...
    b.loadTimeout = 8e3,
    b.LOAD_TIMEOUT = 0,
    b.BINARY = createjs.AbstractLoader.BINARY,
    b.CSS = createjs.AbstractLoader.CSS,
    b.IMAGE = createjs.AbstractLoader.IMAGE,
    b.JAVASCRIPT = createjs.AbstractLoader.JAVASCRIPT,
    b.JSON = createjs.AbstractLoader.JSON,
    b.JSONP = createjs.AbstractLoader.JSONP,
    b.MANIFEST = createjs.AbstractLoader.MANIFEST,
    b.SOUND = createjs.AbstractLoader.SOUND,
    b.VIDEO = createjs.AbstractLoader.VIDEO,
    b.SVG = createjs.AbstractLoader.SVG,
    b.TEXT = createjs.AbstractLoader.TEXT,
    b.XML = createjs.AbstractLoader.XML,
    b.POST = createjs.AbstractLoader.POST,
    b.GET = createjs.AbstractLoader.GET,
    ...
    a.setPreferXHR = function(a) {
        return this.preferXHR = 0 != a && null != window.XMLHttpRequest,
        this.preferXHR
    }
    ,
    ...
    a._addItem = function(a, b, c) {
        ...
        if (null != d) {
            ...
            (this.maintainScriptOrder && d.type == createjs.LoadQueue.JAVASCRIPT || d.maintainOrder === !0) && (this._scriptOrder.push(d),
    ...
    a._loadNext = function() {
        if (!this._paused) {
            ...
            for (var a = 0; a < this._loadQueue.length && !(this._currentLoads.length >= this._maxConnections); a++) {
                ...
                this._canStartLoad(b) && (this._loadQueue.splice(a, 1),
                a--,
                this._loadItem(b))
            }
        }
    ...
    a._handleError = function(a) {
        ...
        this._sendError(c),
        this.stopOnError ? this.setPaused(!0) : (this._removeLoadItem(b),
    ...
    a._finishOrderedItem = function(a, b) {
        ...
        if (this.maintainScriptOrder && c.type == createjs.LoadQueue.JAVASCRIPT || c.maintainOrder) {
            ...
            return -1 == d ? !1 : (this._loadedScripts[d] = b === !0 ? !0 : c,
    ...
    a._updateProgress = function() {
        ...
        this._lastProgress != a && (this._sendProgress(a),
...
function() {
    ...
    var a = (createjs.extend(TextLoader, createjs.AbstractLoader),
    TextLoader);
...
function() {
    ...
    a._formatResult = function(a) {
        if (this._preferXHR) {
            ...
            b = this._tag;
        return createjs.DomUtils.appendToHead(b),
        b
    }
    ,
...
function() {
    ...
    a._formatResult = function(a) {
        var b = a.getTag();
        return this._preferXHR && (b.text = a.getResult(!0)),
        b
    }
    ,
...
function() {
    ...
    function VideoLoader(a, b) {
        ...
        createjs.RequestUtils.isVideoTag(a) || createjs.RequestUtils.isVideoTag(a.src) ? (this.setTag(createjs.RequestUtils.isVideoTag(a) ? a : a.src),
...
function() {
    ...
    a.handleEvent = function(a) {
        ...
        case "complete":
            ...
            void this._loadManifest(this._result);
        case "progress":
            return a.loaded *= b.SPRITESHEET_PROGRESS,
            this.progress = a.loaded / a.total,
            (isNaN(this.progress) || 1 / 0 == this.progress) && (this.progress = 0),
            void this._sendProgress(a)
        }
...
function() {
    ...
    function SVGLoader(a, b) {
        ...
        b ? this.setTag(document.createElement("svg")) : (this.setTag(document.createElement("object")),
    ...
    a._formatResult = function(a) {
        ...
        null != b.documentElement ? (c.appendChild(b.documentElement),
