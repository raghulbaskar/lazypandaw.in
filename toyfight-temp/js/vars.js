...
if (isEdge) {
  document.body.setAttribute('data-edge', true);
}

//NUMERICALS / BOOLEANS
var scrollActive;
var smoothScrollActive = (window.innerWidth <= 1024 || isEdge ? false : true);
var mobileScrollEl = document.querySelector('.scrolling-content')
